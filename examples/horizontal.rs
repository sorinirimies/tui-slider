//! Horizontal and Vertical slider example
//!
//! This example demonstrates both horizontal and vertical sliders with consistent styling.
...
fn ui(f: &mut Frame, app: &App) {
    ...
    // Title
    let title = Paragraph::new("Slider Demo - Horizontal & Vertical")
        .style(
            Style::default()
                .fg(Color::Cyan)
    ...
    .alignment(Alignment::Center);
    f.render_widget(h_title, main_chunks[2]);
    ...
    .alignment(Alignment::Center);
    f.render_widget(v_title, main_chunks[4]);
    ...
    render_horizontal_sliders(f, app, main_chunks[1]);

    // Render vertical sliders
    render_vertical_sliders(f, app, main_chunks[3]);
}

fn render_horizontal_sliders(f: &mut Frame, app: &App, area: ratatui::layout::Rect) {
...
fn render_vertical_sliders(f: &mut Frame, app: &App, area: ratatui::layout::Rect) {
