        ...
        Self {
            progress_bars: vec![
                ...
                ProgressBar {
                    ...
                    state: SliderState::with_step(55.0, 0.0, 100.0, 2.0),
                    filled_symbol: "▰",
                    empty_symbol: "▱",
                    filled_color: Color::LightGreen,
                    empty_color: Color::DarkGray,
                    description: "Character stamina".to_string(),
                },
                ProgressBar {
                    label: "Rendering".to_string(),
                    state: SliderState::with_step(15.0, 0.0, 100.0, 0.5),
                    filled_symbol: "█",
                    empty_symbol: "▒",
                    filled_color: Color::LightCyan,
                    empty_color: Color::Rgb(50, 50, 50),
                    description: "Video render progress".to_string(),
                },
            ],
            auto_progress: false,
        }
